...
{
    public class REG_00000_LAYOUT_ATE_2017
    {
        /// <summary>
        ...
        /// <summary>
        /// Índice de Majoração Federal aplicado na receita interna
        /// </summary>
        [CampoArquivoPGDASD(_ordem: 23)]
        public decimal IM_Int { get; set; }


        /// <summary>
        /// Índice de Majoração Federal aplicado na receita externa
        /// </summary>
        [CampoArquivoPGDASD(_ordem: 24)]
        public decimal IM_Ext { get; set; }
